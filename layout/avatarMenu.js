...
// block scoping
{
  ...
  function setThemeIcon() {
    ...
    switch (theme) {
      case "dark":
        ...
        document.querySelector(".theme-system-default-icon").classList.remove("show");
        break;
      case "light":
        ...
        break;
      default:
        document.querySelector(".theme-system-default-icon").classList.add("show");
        document.querySelector(".theme-dark-icon").classList.remove("show");
        document.querySelector(".theme-light-icon").classList.remove("show");
    }
  }
  ...
  const fullscreenToggleButtonEl = document.getElementById("fullscreen-toggle-button");
