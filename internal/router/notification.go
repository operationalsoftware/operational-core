...
func addNotificationRoutes(
	...
	mux.HandleFunc("GET /notifications/{id}", notificationHandler.OpenNotification)
	mux.HandleFunc("GET /notifications/tray", notificationHandler.NotificationsTray)
	mux.HandleFunc("GET /notifications/test", notificationHandler.NotificationTestPage)
	mux.HandleFunc("POST /notifications/test", notificationHandler.SendTestNotification)
